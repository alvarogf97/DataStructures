...
intersection b Empty = Empty
intersection Empty b = Empty
intersection (Node x ocurr b) (Node x' ocurr' b') | x == x' = (Node x (min ocurr ocurr') (intersection b b'))
                                                  | x <  x' = intersection b (Node x' ocurr' b')
                                                  | otherwise = intersection (Node x ocurr b) b'
